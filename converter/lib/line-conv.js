			...
			parseVars.pageJson.lines.forEach(element => {
				switch (element.type) {
					case "panel":
						...
						break;
					case "char":
						conv.converter.CharacterName(element.text);
						break;
					case "dialog":
						conv.converter.Dialog(element.text, element.number);
						break;
					case "paren":
						conv.converter.DialogParenthetical(element.text);
						break;
					case "letnote":
						conv.converter.LetteringNote(element.text);
						break;
					case "comment":
						conv.converter.Comment(element.text);
						break;
					default:
						conv.converter.StandardLine(element.text);
						break;
				}				
			});
		} else {
